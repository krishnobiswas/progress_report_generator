    ...
    <div class="row-fluid">
        <div class="span12">
            ...
            <ul class="breadcrumb">
                ...
                <li class="active">Search Info</li>
            </ul>
        </div>
        <div class="row-fluid">
            <div class="span12">
                ...
                <div class="widget red">
                    <div class="widget-title">
                        <h3 align='center' style="color:wheat"><b><i></i>Search Result</b></h3>
                        <span class="tools">
                    ...
                    <div class="widget-body">
                        <table id="" class="table table-striped table-bordered table-advance table-hover">
                            <thead>
                                <tr>
                                    <th><i class="icon-bullhorn"></i>Student ID</th>
                                    ...
                                    <th></th>
                                    <th><i class="icon-edit-sign"></i>Setting</th>
                                    <th></th>
                                </tr>
                            </thead>
                            <tbody>
                                <?php foreach ($search_info as $info) { ?>
                                    <tr>
                                        ...
                                        <th>{{$info->stu_roll}}</th>
                                        <th>{{$info->stu_reg}}</th>
                                        <th><a href="{{URL::to('/edit-student/'.$info->stu_id)}}"><button type="button" class="btn btn-success"><i class="icon-people"></i>Edit</button></a></th>
                                        <th><button type="button" class="btn btn-primary" data-toggle="modal" data-target="#clientModal{{$info->stu_id}}">
                                                view
                                            </button>
